...
class CjuevesHandler(BaseHandler):
    ...
    async def can_handle(self, texto: str, numero: str, user_state: dict) -> bool:
        ...
        keywords = ["limpieza", "100 jueves", "deshierbe"]
    ...
    async def handle_message(self, texto: str, numero: str, name: str, msg_id: str) -> List[Dict[str, Any]]:
        dataList = []
        payload = crear_payload_texto(numero, "🌿 Contáctate con 100 Jueves de acción!\nhttps://wa.me/59162277490", True)
