...
async def manejar_info_certificado_pu_c(numero: str) -> List[Dict]:
    dataList = []

    cuerpo = (
        "*¿Qué es un certificado de registro catastral?*\n\n"
        "Consiste en el registro de la información del bien inmueble proporcionada por un profesional externo "
        "contratado por el propietario, previa verificación en el Módulo de Catastro del Sistema de Información "
        "Territorial (SIT V2) del Gobierno Autónomo Municipal de La Paz.\n\n"
        "El certificado determina la ubicación geográfica, características físicas y la valoración del bien inmueble.\n\n"
