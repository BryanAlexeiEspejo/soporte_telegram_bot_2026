# app/services/handlers/catastro/B_2_4_info_2_E.py
...
async def manejar_info_duplicado_e(numero: str) -> List[Dict]:
    dataList: List[Dict] = []

    cuerpo = (
        "📄 *¿Tiene un costo?*\n\n"
        "💰 El costo del trámite es de *56.30 Bs.*, vigente al mes de *diciembre de 2025*.\n\n"
    )
    ...
    await set_estado_usuario(numero, {"contexto": "catastro", "estado": "duplicado-certificado-info-e"})
    return dataList
