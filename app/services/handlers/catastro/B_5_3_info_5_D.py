...
async def manejar_info_emision_cert_ley247_d(numero: str) -> List[Dict]:
    dataList = []

    # ✅ Cuerpo del mensaje
    cuerpo = (
        "*¿Para qué sirve un certificado de registro catastral?*\n\n"
        "Permite a los ciudadanos poder realizar el trámite ante las Oficinas de Derechos Reales, "
        "previo cumplimiento de los requisitos señalados por dicha instancia, para la regularización "
        "de la superficie en demasía en el marco de la Ley 247."
    )
   ...
   # ✅ Función auxiliar para crear filas
    ...
    await set_estado_usuario(numero, {
        "contexto": "catastro",
        "estado": "emision-cert-ley247-info-d"
    })
