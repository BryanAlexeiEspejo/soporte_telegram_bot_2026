# app/services/handlers/catastro/B_3_3_info_3_D.py

from typing import List, Dict
from app.services.whatsapp_template import crear_payload_lista
from app.database.database import set_estado_usuario

async def manejar_info_actualizacion_d(numero: str) -> List[Dict]:
    dataList = []

    cuerpo = (
        "📄 *¿Para qué sirve un certificado de registro catastral actualizado?*\n\n"
        "✅ Permite mantener la *información oficial del inmueble al día*.\n"
        "✅ Es necesario para operaciones en:\n"
        "• El Gobierno Autónomo Municipal de La Paz (GAMLP)\n"
        "• *Derechos Reales*\n"
    ...
    await set_estado_usuario(numero, {
        "contexto": "catastro",
        "estado": "actualizacion-registro-info-d"
    })
