...
async def manejar_info_certificado_pu_f(numero: str) -> List[Dict]:
    dataList = []

    cuerpo = (
        "*¿Qué obtengo al hacer este trámite?*\n\n"
        "✅ El resultado final es el *Certificado de Registro Catastral*.\n\n"
        "Este documento es una prueba técnica oficial de que el predio está debidamente registrado "
        "en el sistema catastral del municipio.\n\n"
