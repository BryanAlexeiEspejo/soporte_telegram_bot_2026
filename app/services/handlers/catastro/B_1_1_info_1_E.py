...
async def manejar_info_certificado_pu_e(numero: str) -> List[Dict]:
    dataList = []

    cuerpo = (
        "*¿Tiene un costo?*\n\n"
        "✅ Sí, el trámite tiene un costo.\n\n"
        "A través de un profesional externo, tiene un costo de *164.10 Bs* (al mes de diciembre de 2025). "
        "Sin embargo, este valor puede variar según el Servicio Municipal correspondiente.\n\n"
        "Te recomendamos consultar en la oficina de catastro más cercana para conocer el costo actualizado en bolivianos u otra moneda aplicable.\n\n"
