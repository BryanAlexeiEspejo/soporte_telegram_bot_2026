...
async def manejar_info_emision_cert_ley247_g(numero: str) -> List[Dict]:
    dataList = []

    # ✅ Cuerpo explicativo del trámite
    cuerpo = (
        ...
        "Sí, puedes realizar el trámite en nombre de otra persona, "
        "pero debes presentar un *poder notarial* que te autorice a realizar trámites en nombre del propietario.\n\n"
        "*Importante:*\n"
        "• Si el propietario ha fallecido, los herederos deben primero realizar la *declaratoria de herederos* para actualizar los datos del catastro.\n"
        "• En casos de *propiedad compartida* (varios propietarios), cualquiera de los copropietarios puede realizar el trámite, "
        "siempre y cuando cuente con los documentos necesarios y sea titular o apoderado."
    )
    ...
    await set_estado_usuario(numero, {
        "contexto": "catastro",
        "estado": "emision-cert-ley247-info-g"
    })
