# app/services/handlers/catastro/B_2_5_info_2_F.py
...
async def manejar_info_duplicado_f(numero: str) -> List[Dict]:
    dataList: List[Dict] = []

    cuerpo = (
        "📄 *¿Qué obtengo al hacer este trámite?*\n\n"
        "📌 El ciudadano obtiene un *duplicado del certificado catastral*"
    )
    ...
    await set_estado_usuario(numero, {"contexto": "catastro", "estado": "duplicado-certificado-info-f"})
    return dataList
