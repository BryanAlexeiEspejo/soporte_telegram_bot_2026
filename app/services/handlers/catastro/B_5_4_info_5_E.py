...
async def manejar_info_emision_cert_ley247_e(numero: str) -> List[Dict]:
    dataList = []

    # ✅ Cuerpo del mensaje
    cuerpo = (
        "*¿Tiene un costo este trámite?*\n\n"
        "El costo varía dependiendo de cada caso. Según el tarifario oficial al mes de *diciembre de 2024*, los montos son:\n\n"
        "• Certificado de Registro Catastral para inmuebles con superficie *hasta 999 m²*: _534,70 Bs._\n"
        "• Certificado para superficies de *1000 hasta 1999,9 m²*: _795,50 Bs._\n"
        "• Certificado para superficies *iguales o mayores a 2000 m²*: _1.326,90 Bs._"
    )
