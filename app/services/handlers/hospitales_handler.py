...
class HospitalesHandler(BaseHandler):
    """Handler para hospitales municipales"""
    ...
    async def can_handle(self, texto: str, numero: str, user_state: dict) -> bool:
        ...
        keywords = ["hospital", "hospitales", "médico", "medico", "cita", "médica", "medica", "salud"]
    ...
    async def handle_message(self, texto: str, numero: str, name: str, msg_id: str) -> List[Dict[str, Any]]:
        dataList = []
        msg = ("🚑 Pronto este servicio estará activo para hospitales municipales. ¡Gracias por tu interés!\n"
