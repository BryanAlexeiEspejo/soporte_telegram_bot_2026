# app/services/handlers/atm/A_6_1_atencion_y_soporte.py
# (si usas acento en el nombre: A_6_1_atención_y_soporte.py)
...
# ✅ Respuesta 6-1
async def manejar_A_6_1_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Puedo beneficiarme de la Ley Nº 573 si tengo procesos de fiscalización?*\n"
        "R. Puedes beneficiarte siempre y cuando se actualice primero la información "
        "que se observa en el proceso y luego puede realizar el pago al contado o "
