# app/services/handlers/atm/A_3_3_pregunta_3.py
...
# ✅ Respuesta 3-3
async def manejar_A_3_3_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Dónde puedo pagar mis impuestos de forma personal?*\n"
        "R. Puedes pagar en entidades financieras autorizadas.\n"
        ...
        "• La Primera E.F.V.\n• Cajas en oficinas de la ATM (Mercado y Colón, Ex Banco del Estado)\n"
