# app/services/handlers/atm/A_3_7_pregunta_3.py
...
# ✅ Respuesta 3-7
async def manejar_A_3_7_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Dónde puedo consultar mi deuda para acceder al beneficio del perdonazo?*\n"
        "R. Puedes consultar si tienes deudas pendientes y acogerte a los beneficios de la Ley N° 573 en los siguientes enlaces oficiales:\n"
        "• *Patentes Municipales:* https://sierra247.lapaz.bo/SierraValle_Oficial/public/consultaCiudadana/actividadEconomica\n"
        "• *Inmuebles:* https://www.ruat.gob.bo/inmuebles/reportedeudalm/InicioBusquedaInmueble.jsf\n"
        "• *Vehículos:* https://www.ruat.gob.bo/vehiculos/reportedeudalm/InicioBusquedaVehiculo.jsf\n"
