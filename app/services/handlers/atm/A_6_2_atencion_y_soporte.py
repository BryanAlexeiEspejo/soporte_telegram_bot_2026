# app/services/handlers/atm/A_6_2_atencion_y_soporte.py
# (si usas acento: A_6_2_atención_y_soporte.py)
...
# ✅ Respuesta 6-2
async def manejar_A_6_2_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Si me dejan una invitación puedo acogerme a la Ley Nº 573?*\n"
        "R. Si, previamente actualiza la información o Datos Técnicos observados "
        "puede beneficiarse con esta Ley.\n"
