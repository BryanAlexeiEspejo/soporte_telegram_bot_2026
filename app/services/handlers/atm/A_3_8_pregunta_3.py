# app/services/handlers/atm/A_3_8_pregunta_3.py
...
# ✅ Respuesta 3-8  (cuerpo compactado < 1024 chars)
async def manejar_A_3_8_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Qué necesito para acceder a las facilidades de pago?*\n"
        "R. Presenta en plataformas de la ATM, según tu caso:\n"
        "✅ *Personas naturales:* CI vigente (original y fotocopia).\n"
        "✅ *Herederos:* documento legal de herencia + CI del heredero.\n"
        "✅ *Personas jurídicas:* testimonio de poder del representante (si no está registrado) + CI.\n"
        "✅ *Apoderados:* poder notariado para trámites tributarios + CI del apoderado.\n"
        "✅ *Poseedores de buena fe (vehículos):* CI + uno de: minuta de compra-venta, CRPVA o doc. de importación.\n"
        "✅ *Formulario de solicitud:* se genera al iniciar el trámite — N° 499 (Inmuebles), N° 500 (Vehículos), N° 501 (Patentes).\n"
        "✅ *Pago inicial:* debe hacerse el mismo día que se genera el formulario.\n"
