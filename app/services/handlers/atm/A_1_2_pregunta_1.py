# app/services/handlers/atm/A_1_2_pregunta_1.py
...
# ✅ Respuesta 1-2
async def manejar_A_1_2_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Quiénes pueden beneficiarse con esta Ley?*\n"
        "R. Todos los sujetos pasivos, terceros responsables y poseedores de buena fe (solo vehículos) "
        "que tengan deudas pendientes en los impuestos municipales dentro de la jurisdicción del Municipio de La Paz.\n"
