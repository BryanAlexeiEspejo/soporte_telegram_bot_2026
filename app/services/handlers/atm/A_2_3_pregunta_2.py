# app/services/handlers/atm/A_2_3_pregunta_2.py
...
# ✅ Respuesta 2-3
async def manejar_A_2_3_respuesta(numero: str) -> List[Dict]:
    cuerpo = (
        "*¿Qué beneficios obtengo si me acojo a esta Ley?*\n"
        "R. Al acogerte a la Ley N° 573, solo pagarás el monto total del tributo omitido, "
        "actualizando la fecha de pago, sin intereses, sin multas ni sanciones.\n"
